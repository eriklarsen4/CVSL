...
Player_Batting_ALL2 = Player_Batting_ALL2 %>%
  dplyr::mutate(bbref_id = case_when(grepl(Name, pattern = "Ryan") &
                                     ...
                                     grepl(Name, pattern = "Allen") &
                                       grepl(Name, pattern = "Nick") ~ CHAD_LU %>%
...
# Clean the 2022 df ----
  ## Remove the first 4 rows and the extra columns
CVSL_Draft_2022 = CVSL_Draft_2022[ -c(1:4), -c(seq(7, ncol(CVSL_Draft_2022), 7)) ]
...
DRAFTS2 = DRAFTS2 %>%
  dplyr::mutate(bbref_id = case_when(grepl(Name, pattern = "Adrian Morejon") ~ CHAD_LU %>%
                                     ...
                                     grepl(Name, pattern = "Edwin Diaz") ~ CHAD_LU %>%
...
DRAFTS = DRAFTS %>%
    ...
    dplyr::filter(!(grepl(CVSLTeam, pattern = "Renegades") & key_bbref == "cruzne01")) %>%
