...
```{r include = TRUE, warning = FALSE, echo = FALSE, message = FALSE, render = TRUE}
...
```{r include = TRUE, message = FALSE, echo = TRUE, warning = FALSE, render = TRUE}
  ## Graph on one plot
...
+ Now graph that data
```{r include = TRUE, warning = FALSE, echo = TRUE, message = FALSE, render = TRUE}
