...
```{r Global Major League FA Contract Trends, fig.show='asis', include = TRUE, warning = FALSE, echo = FALSE, message = FALSE, render = TRUE}
...
MLdealTotTrend = ggplot(data = FREE_AGENTS, aes(x = Year)) +
  ...
  labs(title = "Total ML Contracts Signed\n2011-2021", x = "Off-Season", y = "# of Signed ML Contracts", color = "Stat") + 
  theme_bw() +
...
TotalMoneySpent = ggplot(data = FREE_AGENTS, aes(x = Year)) +
  ...
  labs(title = "Total Spent on ML Contracts\n2011-2021", x = "Off-Season", y = "Total Spent (in B $US)", color = "Stat") + 
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15),
        legend.position = "none",
        axis.ticks.x = element_blank(),
...
ggarrange(MLdealTotTrend, TotalMoneySpent, ncol = 2, nrow = 1, common.legend = FALSE, labels = "AUTO")
```
...
MeanMedAAV = ggplot(data = FREE_AGENTS, aes(x = Year)) +
  ...
  labs(title = "ML Contract AAV\n2011-2021", x = "Off-Season", y = "Mean AAV (in M $US)", color = "Stat") + 
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15),
        legend.position = "none",
        axis.ticks.x = element_blank(),
...
MeanMedAAV = MeanMedAAV + scale_y_continuous(sec.axis = sec_axis(~.*1, name = "Median AAV (in M $US)"))
MeanMedAAV = MeanMedAAV +
...
MeanMedLength = ggplot(data = FREE_AGENTS, aes(x = Year)) +
  ...
  labs(title = "ML Contract Length\n2011-2021", x = "Off-Season", y = "Mean ML\nContract Length (years)", color = "Stat") + 
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15),
        legend.position = "none",
        axis.ticks.x = element_blank(),
...
MeanMedLength = MeanMedLength + scale_y_continuous(sec.axis = sec_axis(~.*1, name = "Median ML\nContract Length (years)"))
MeanMedLength = MeanMedLength +
...
MeanMedTotVal = ggplot(data = FREE_AGENTS, aes(x = Year)) +
  ...
  labs(title = "ML Total Contract Value\n2011-2021", x = "Off-Season", y = "Mean ML Total\nContract Value (in M $US)", color = "Stat") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15),
        legend.position = "none",
        axis.ticks.x = element_blank(),
...
MeanMedTotVal = MeanMedTotVal + scale_y_continuous(sec.axis = sec_axis(~.*1, name = "Median ML Total\nContract Value (in M $US)"))
MeanMedTotVal = MeanMedTotVal +
...
MeanMedAge = ggplot(data = FREE_AGENTS, aes(x = Year)) +
  ...
  labs(title = "ML Total Contract Age\n2011-2021", x = "Off-Season", y = "Mean Age (years)", color = "Stat") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5, size = 15),
        legend.position = "none",
        axis.ticks.x = element_blank(),
...
MeanMedAge = MeanMedAge + scale_y_continuous(sec.axis = sec_axis(~.*1, name = "Median Age (years)"))
MeanMedAge = MeanMedAge +
...
```{r Mean and Median MLB FA Total Contract Value AAV Contract Length and Player Age, fig.show='asis',include = TRUE, message = FALSE, echo = TRUE, warning = FALSE, render = TRUE}
  ## Graph on one plot
...
+ Now graph that data
```{r Minor League Contract data, fig.show='asis', include = TRUE, warning = FALSE, echo = TRUE, message = FALSE, render = TRUE}
...
```{r MLB FA Contract AAV Distributions, fig..show='asis', include = TRUE, warning = FALSE, echo = TRUE, message = FALSE, render = TRUE}
